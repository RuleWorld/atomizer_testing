...
<COPASI xmlns="http://www.copasi.org/static/schema" versionMajor="4" versionMinor="16" versionDevel="104" copasiSourcesModified="0">
  <Model key="Model_3" name="Das2010 - Effect of a gamma-secretase inhibitor on Amyloid-beta dynamics" simulationType="time" timeUnit="h" volumeUnit="ml" areaUnit="m²" lengthUnit="m" quantityUnit="mmol" type="deterministic" avogadroConstant="6.02214179e+23">
    <MiriamAnnotation>
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Model_3">
    ...
    <bqbiol:hasTaxon>
      <rdf:Bag>
        <rdf:li rdf:resource="http://identifiers.org/taxonomy/9544"/>
      </rdf:Bag>
    </bqbiol:hasTaxon>
    ...
    <dcterms:modified>
      <rdf:Description>
        <dcterms:W3CDTF>2014-12-12T15:02:29Z</dcterms:W3CDTF>
      </rdf:Description>
    </dcterms:modified>
    <CopasiMT:is>
      <rdf:Bag>
    ...
    <CopasiMT:is>
      <rdf:Bag>
        <rdf:li rdf:resource="http://identifiers.org/biomodels.db/BIOMD0000000551"/>
      </rdf:Bag>
    </CopasiMT:is>
  ...
  <body xmlns="http://www.w3.org/1999/xhtml">
    <div class="dc:title">Das2010 - Effect of a gamma-secretase
inhibitor on Amyloid-beta dynamics</div>
  ...
  and identified by: 
  <a href="http://identifiers.org/biomodels.db/BIOMD0000000551">BIOMD0000000551</a>.</p>
...
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Compartment_1">
    <CopasiMT:is>
      <rdf:Bag>
        <rdf:li rdf:resource="http://identifiers.org/bto/BTO:0000237"/>
      </rdf:Bag>
    </CopasiMT:is>
  </rdf:Description>
</rdf:RDF>
...
<Report reference="Report_90" target="output_551.txt" append="0"/>
      <Problem>
...
<Report key="Report_90" name="Time, Concentrations, Volumes, and Global Quantity Values" taskType="timeCourse" separator="&#x09;" precision="6"> 
          <Table printTitle="1"> 
            <Object cn="CN=Root,Model=Das2010 - Effect of a gamma-secretase inhibitor on Amyloid-beta dynamics,Reference=Time"/> 
	<Object cn="CN=Root,Model=Das2010 - Effect of a gamma-secretase inhibitor on Amyloid-beta dynamics,Vector=Compartments[CSF],Vector=Metabolites[C],Reference=Concentration"/> 
	<Object cn="CN=Root,Model=Das2010 - Effect of a gamma-secretase inhibitor on Amyloid-beta dynamics,Vector=Compartments[Plasma],Vector=Metabolites[P],Reference=Concentration"/> 
	<Object cn="CN=Root,Model=Das2010 - Effect of a gamma-secretase inhibitor on Amyloid-beta dynamics,Vector=Values[l],Reference=Value"/> 
</Table> 
</Report>
  ...
  <SBMLReference file="BIOMD0000000551.xml">
