...
<COPASI xmlns="http://www.copasi.org/static/schema" versionMajor="4" versionMinor="16" versionDevel="104" copasiSourcesModified="0">
  ...
  <Model key="Model_3" name="Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ)" simulationType="time" timeUnit="s" volumeUnit="ml" areaUnit="m²" lengthUnit="m" quantityUnit="nmol" type="deterministic" avogadroConstant="6.02214179e+23">
    <MiriamAnnotation>
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Model_3">
    ...
    <dcterms:created>
      <rdf:Description>
        <dcterms:W3CDTF>2012-11-23T16:21:55Z</dcterms:W3CDTF>
      </rdf:Description>
    </dcterms:created>
    <dcterms:creator>
      <rdf:Bag>
    ...
    <dcterms:modified>
      <rdf:Description>
        <dcterms:W3CDTF>2014-05-30T18:21:39Z</dcterms:W3CDTF>
      </rdf:Description>
    </dcterms:modified>
    <CopasiMT:is>
      <rdf:Bag>
        <rdf:li rdf:resource="http://identifiers.org/biomodels.db/MODEL1204280040"/>
      </rdf:Bag>
    </CopasiMT:is>
    <CopasiMT:is>
      <rdf:Bag>
        <rdf:li rdf:resource="http://identifiers.org/biomodels.db/BIOMD0000000433"/>
      </rdf:Bag>
    </CopasiMT:is>
  ...
  <body xmlns="http://www.w3.org/1999/xhtml">
    <div class="dc:title">Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ)</div>
  ...
  <p>This model [        <a href="http://identifiers.org/biomodels.db/MODEL1204280040">MODEL1204280040</a>
            - M4_K2_QSS_PSEQ] correspond to type M4 with mass-action kinetics K2, in QSS (quasi steady state) and USEQ (Unsequestrated ) condition.
            .        </p>
  ...
  <p>This model is hosted on        <a href="http://www.ebi.ac.uk/biomodels">BioModels Database</a>
            and identified by:        <a href="http://identifiers.org/biomodels.db/MODEL1204280040">MODEL1204280040</a>
    ...
    <CopasiMT:isVersionOf>
      <rdf:Bag>
        ...
        <ListOfConstants>
          ...
          <Constant key="Parameter_4339" name="parameter_11" value="0.06"/>
    ...
    <CopasiMT:isVersionOf>
      <rdf:Bag>
        ...
        <ListOfConstants>
          ...
          <Constant key="Parameter_4326" name="parameter_11" value="0.06"/>
          <Constant key="Parameter_4325" name="parameter_12" value="0.06"/>
    ...
    <CopasiMT:isVersionOf>
      <rdf:Bag>
        ...
        <ListOfConstants>
          ...
          <Constant key="Parameter_4315" name="parameter_11" value="0.06"/>
          <Constant key="Parameter_4314" name="parameter_12" value="0.06"/>
    ...
    <CopasiMT:isVersionOf>
      <rdf:Bag>
        ...
        <ListOfConstants>
          ...
          <Constant key="Parameter_4299" name="parameter_12" value="0.06"/>
...
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Reaction_9">
    <CopasiMT:isVersionOf>
      <rdf:Bag>
        ...
        <ListOfConstants>
          ...
          <Constant key="Parameter_4293" name="parameter_12" value="0.06"/>
    ...
    <ListOfModelParameterSets activeSet="ModelParameterSet_1">
      <ModelParameterSet key="ModelParameterSet_1" name="Initial State">
        <ModelParameterGroup cn="String=Initial Time" type="Group">
          <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ)" value="0" type="Model" simulationType="time"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Initial Compartment Sizes" type="Group">
          <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Compartments[compartment]" value="1" type="Compartment" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Compartments[No Name]" value="1" type="Compartment" simulationType="fixed"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Initial Species Values" type="Group">
          <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Compartments[compartment],Vector=Metabolites[MKKK]" value="1.806642537e+17" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Compartments[compartment],Vector=Metabolites[MKKK_P]" value="0" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Compartments[compartment],Vector=Metabolites[MKK]" value="7.226569800000001e+17" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Compartments[compartment],Vector=Metabolites[MKK_P]" value="0" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Compartments[compartment],Vector=Metabolites[MKK_PP]" value="0" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Compartments[compartment],Vector=Metabolites[MK]" value="7.226569800000001e+17" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Compartments[compartment],Vector=Metabolites[MK_P]" value="0" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Compartments[compartment],Vector=Metabolites[MK_PP]" value="0" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Compartments[compartment],Vector=Metabolites[P1]" value="6.02214179e+16" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Compartments[compartment],Vector=Metabolites[P2]" value="1.204428358e+17" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Compartments[compartment],Vector=Metabolites[Sig]" value="1.204428358e+16" type="Species" simulationType="reactions"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Values[K1]" value="100" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Values[K2a]" value="54.3" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Values[K3]" value="50.5" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Values[K4]" value="500" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Values[K5a]" value="24.3" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Values[K6a]" value="108.6" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Values[K7]" value="50.5" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Values[K8]" value="500" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Values[K9b]" value="24.3" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Values[K10b]" value="108.6" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Values[Kse1]" value="0.06" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Values[Kse2]" value="0.06" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Values[K5b]" value="24.3" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Values[K6b]" value="108.6" type="ModelValue" simulationType="fixed"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Kinetic Parameters" type="Group">
          <ModelParameterGroup cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[1]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[1],ParameterGroup=Parameters,Parameter=k1" value="1" type="ReactionParameter" simulationType="fixed"/>
            <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[1],ParameterGroup=Parameters,Parameter=parameter_1" value="100" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Values[K1],Reference=InitialValue&gt;
              </InitialExpression>
            </ModelParameter>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[2]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[2],ParameterGroup=Parameters,Parameter=k2a" value="0.08599999999999999" type="ReactionParameter" simulationType="fixed"/>
            <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[2],ParameterGroup=Parameters,Parameter=parameter_11" value="0.06" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Values[Kse1],Reference=InitialValue&gt;
              </InitialExpression>
            </ModelParameter>
            <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[2],ParameterGroup=Parameters,Parameter=parameter_2" value="54.3" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Values[K2a],Reference=InitialValue&gt;
              </InitialExpression>
            </ModelParameter>
            <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[2],ParameterGroup=Parameters,Parameter=parameter_5" value="24.3" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Values[K5a],Reference=InitialValue&gt;
              </InitialExpression>
            </ModelParameter>
            <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[2],ParameterGroup=Parameters,Parameter=parameter_6" value="108.6" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Values[K6a],Reference=InitialValue&gt;
              </InitialExpression>
            </ModelParameter>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[3]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[3],ParameterGroup=Parameters,Parameter=k3" value="0.01" type="ReactionParameter" simulationType="fixed"/>
            <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[3],ParameterGroup=Parameters,Parameter=parameter_3" value="50.5" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Values[K3],Reference=InitialValue&gt;
              </InitialExpression>
            </ModelParameter>
            <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[3],ParameterGroup=Parameters,Parameter=parameter_4" value="500" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Values[K4],Reference=InitialValue&gt;
              </InitialExpression>
            </ModelParameter>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[4]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[4],ParameterGroup=Parameters,Parameter=k4" value="15" type="ReactionParameter" simulationType="fixed"/>
            <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[4],ParameterGroup=Parameters,Parameter=parameter_3" value="50.5" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Values[K3],Reference=InitialValue&gt;
              </InitialExpression>
            </ModelParameter>
            <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[4],ParameterGroup=Parameters,Parameter=parameter_4" value="500" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Values[K4],Reference=InitialValue&gt;
              </InitialExpression>
            </ModelParameter>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[5]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[5],ParameterGroup=Parameters,Parameter=k5a" value="0.092" type="ReactionParameter" simulationType="fixed"/>
            <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[5],ParameterGroup=Parameters,Parameter=k5b" value="0.092" type="ReactionParameter" simulationType="fixed"/>
            <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[5],ParameterGroup=Parameters,Parameter=parameter_10" value="108.6" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Values[K10b],Reference=InitialValue&gt;
              </InitialExpression>
            </ModelParameter>
            <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[5],ParameterGroup=Parameters,Parameter=parameter_11" value="0.06" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Values[Kse1],Reference=InitialValue&gt;
              </InitialExpression>
            </ModelParameter>
            <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[5],ParameterGroup=Parameters,Parameter=parameter_12" value="0.06" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Values[Kse2],Reference=InitialValue&gt;
              </InitialExpression>
            </ModelParameter>
            <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[5],ParameterGroup=Parameters,Parameter=parameter_13" value="24.3" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Values[K5b],Reference=InitialValue&gt;
              </InitialExpression>
            </ModelParameter>
            <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[5],ParameterGroup=Parameters,Parameter=parameter_14" value="108.6" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Values[K6b],Reference=InitialValue&gt;
              </InitialExpression>
            </ModelParameter>
            <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[5],ParameterGroup=Parameters,Parameter=parameter_2" value="54.3" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Values[K2a],Reference=InitialValue&gt;
              </InitialExpression>
            </ModelParameter>
            <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[5],ParameterGroup=Parameters,Parameter=parameter_5" value="24.3" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Values[K5a],Reference=InitialValue&gt;
              </InitialExpression>
            </ModelParameter>
            <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[5],ParameterGroup=Parameters,Parameter=parameter_6" value="108.6" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Values[K6a],Reference=InitialValue&gt;
              </InitialExpression>
            </ModelParameter>
            <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[5],ParameterGroup=Parameters,Parameter=parameter_9" value="24.3" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Values[K9b],Reference=InitialValue&gt;
              </InitialExpression>
            </ModelParameter>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[6]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[6],ParameterGroup=Parameters,Parameter=k6a" value="0.08599999999999999" type="ReactionParameter" simulationType="fixed"/>
            <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[6],ParameterGroup=Parameters,Parameter=k6b" value="0.08599999999999999" type="ReactionParameter" simulationType="fixed"/>
            <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[6],ParameterGroup=Parameters,Parameter=parameter_10" value="108.6" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Values[K10b],Reference=InitialValue&gt;
              </InitialExpression>
            </ModelParameter>
            <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[6],ParameterGroup=Parameters,Parameter=parameter_11" value="0.06" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Values[Kse1],Reference=InitialValue&gt;
              </InitialExpression>
            </ModelParameter>
            <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[6],ParameterGroup=Parameters,Parameter=parameter_12" value="0.06" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Values[Kse2],Reference=InitialValue&gt;
              </InitialExpression>
            </ModelParameter>
            <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[6],ParameterGroup=Parameters,Parameter=parameter_13" value="24.3" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Values[K5b],Reference=InitialValue&gt;
              </InitialExpression>
            </ModelParameter>
            <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[6],ParameterGroup=Parameters,Parameter=parameter_14" value="108.6" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Values[K6b],Reference=InitialValue&gt;
              </InitialExpression>
            </ModelParameter>
            <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[6],ParameterGroup=Parameters,Parameter=parameter_2" value="54.3" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Values[K2a],Reference=InitialValue&gt;
              </InitialExpression>
            </ModelParameter>
            <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[6],ParameterGroup=Parameters,Parameter=parameter_5" value="24.3" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Values[K5a],Reference=InitialValue&gt;
              </InitialExpression>
            </ModelParameter>
            <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[6],ParameterGroup=Parameters,Parameter=parameter_6" value="108.6" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Values[K6a],Reference=InitialValue&gt;
              </InitialExpression>
            </ModelParameter>
            <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[6],ParameterGroup=Parameters,Parameter=parameter_9" value="24.3" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Values[K9b],Reference=InitialValue&gt;
              </InitialExpression>
            </ModelParameter>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[7]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[7],ParameterGroup=Parameters,Parameter=k7" value="0.01" type="ReactionParameter" simulationType="fixed"/>
            <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[7],ParameterGroup=Parameters,Parameter=parameter_7" value="50.5" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Values[K7],Reference=InitialValue&gt;
              </InitialExpression>
            </ModelParameter>
            <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[7],ParameterGroup=Parameters,Parameter=parameter_8" value="500" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Values[K8],Reference=InitialValue&gt;
              </InitialExpression>
            </ModelParameter>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[8]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[8],ParameterGroup=Parameters,Parameter=k7" value="15" type="ReactionParameter" simulationType="fixed"/>
            <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[8],ParameterGroup=Parameters,Parameter=parameter_7" value="50.5" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Values[K7],Reference=InitialValue&gt;
              </InitialExpression>
            </ModelParameter>
            <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[8],ParameterGroup=Parameters,Parameter=parameter_8" value="500" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Values[K8],Reference=InitialValue&gt;
              </InitialExpression>
            </ModelParameter>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[9]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[9],ParameterGroup=Parameters,Parameter=k9b" value="0.092" type="ReactionParameter" simulationType="fixed"/>
            <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[9],ParameterGroup=Parameters,Parameter=parameter_10" value="108.6" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Values[K10b],Reference=InitialValue&gt;
              </InitialExpression>
            </ModelParameter>
            <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[9],ParameterGroup=Parameters,Parameter=parameter_12" value="0.06" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Values[Kse2],Reference=InitialValue&gt;
              </InitialExpression>
            </ModelParameter>
            <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[9],ParameterGroup=Parameters,Parameter=parameter_13" value="24.3" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Values[K5b],Reference=InitialValue&gt;
              </InitialExpression>
            </ModelParameter>
            <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[9],ParameterGroup=Parameters,Parameter=parameter_14" value="108.6" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Values[K6b],Reference=InitialValue&gt;
              </InitialExpression>
            </ModelParameter>
            <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[9],ParameterGroup=Parameters,Parameter=parameter_9" value="24.3" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Values[K9b],Reference=InitialValue&gt;
              </InitialExpression>
            </ModelParameter>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[10]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[10],ParameterGroup=Parameters,Parameter=k10b" value="0.08599999999999999" type="ReactionParameter" simulationType="fixed"/>
            <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[10],ParameterGroup=Parameters,Parameter=parameter_10" value="108.6" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Values[K10b],Reference=InitialValue&gt;
              </InitialExpression>
            </ModelParameter>
            <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[10],ParameterGroup=Parameters,Parameter=parameter_12" value="0.06" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Values[Kse2],Reference=InitialValue&gt;
              </InitialExpression>
            </ModelParameter>
            <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[10],ParameterGroup=Parameters,Parameter=parameter_13" value="24.3" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Values[K5b],Reference=InitialValue&gt;
              </InitialExpression>
            </ModelParameter>
            <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[10],ParameterGroup=Parameters,Parameter=parameter_14" value="108.6" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Values[K6b],Reference=InitialValue&gt;
              </InitialExpression>
            </ModelParameter>
            <ModelParameter cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Reactions[10],ParameterGroup=Parameters,Parameter=parameter_9" value="24.3" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Values[K9b],Reference=InitialValue&gt;
              </InitialExpression>
            </ModelParameter>
    ...
    <InitialState type="initialState">
      0 0 0 1.806642537e+17 7.226569800000001e+17 7.226569800000001e+17 0 0 0 6.02214179e+16 1.204428358e+17 1.204428358e+16 1 1 100 54.3 50.5 500 24.3 108.6 50.5 500 24.3 108.6 0.06 0.06 24.3 108.6 
    </InitialState>
  </Model>
  <ListOfTasks>
...
<Report reference="Report_90" target="output_433.txt" append="0"/>
      <Problem>
...
<Report key="Report_90" name="Time, Concentrations, Volumes, and Global Quantity Values" taskType="timeCourse" separator="&#x09;" precision="6"> 
          <Table printTitle="1"> 
            <Object cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Reference=Time"/> 
	<Object cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Compartments[compartment],Vector=Metabolites[MKKK],Reference=Concentration"/> 
	<Object cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Compartments[compartment],Vector=Metabolites[MKKK_P],Reference=Concentration"/> 
	<Object cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Compartments[compartment],Vector=Metabolites[MKK],Reference=Concentration"/> 
	<Object cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Compartments[compartment],Vector=Metabolites[MKK_P],Reference=Concentration"/> 
	<Object cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Compartments[compartment],Vector=Metabolites[MKK_PP],Reference=Concentration"/> 
	<Object cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Compartments[compartment],Vector=Metabolites[MK],Reference=Concentration"/> 
	<Object cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Compartments[compartment],Vector=Metabolites[MK_P],Reference=Concentration"/> 
	<Object cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Compartments[compartment],Vector=Metabolites[MK_PP],Reference=Concentration"/> 
	<Object cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Compartments[compartment],Vector=Metabolites[P1],Reference=Concentration"/> 
	<Object cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Compartments[compartment],Vector=Metabolites[P2],Reference=Concentration"/> 
	<Object cn="CN=Root,Model=Sarma2012 - Interaction topologies of MAPK cascade (M4_K2_QSS_PSEQ),Vector=Compartments[compartment],Vector=Metabolites[Sig],Reference=Concentration"/> 
</Table> 
</Report>
  ...
  <SBMLReference file="BIOMD0000000433.xml">
