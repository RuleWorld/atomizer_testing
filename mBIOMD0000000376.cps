...
<COPASI xmlns="http://www.copasi.org/static/schema" versionMajor="4" versionMinor="16" versionDevel="104" copasiSourcesModified="0">
  <Model key="Model_3" name="Bertram2007_IsletCell_Oscillations" simulationType="time" timeUnit="s" volumeUnit="l" areaUnit="m²" lengthUnit="m" quantityUnit="mol" type="deterministic" avogadroConstant="6.02214179e+23">
    <MiriamAnnotation>
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Model_3">
    ...
    <dcterms:bibliographicCitation>
      <rdf:Bag>
        <rdf:li>
          <rdf:Description>
            <CopasiMT:isDescribedBy rdf:resource="http://identifiers.org/pubmed/17172305"/>
          </rdf:Description>
        </rdf:li>
      </rdf:Bag>
    </dcterms:bibliographicCitation>
    <dcterms:created>
      <rdf:Description>
        <dcterms:W3CDTF>2011-09-29T22:13:00Z</dcterms:W3CDTF>
      </rdf:Description>
    </dcterms:created>
    <dcterms:creator>
      <rdf:Bag>
    ...
    <dcterms:modified>
      <rdf:Description>
        <dcterms:W3CDTF>2014-05-28T20:39:27Z</dcterms:W3CDTF>
      </rdf:Description>
    </dcterms:modified>
    <CopasiMT:is>
      <rdf:Bag>
        <rdf:li rdf:resource="http://identifiers.org/biomodels.db/MODEL7889980156"/>
      </rdf:Bag>
    </CopasiMT:is>
    <CopasiMT:is>
      <rdf:Bag>
        <rdf:li rdf:resource="http://identifiers.org/biomodels.db/BIOMD0000000376"/>
      </rdf:Bag>
    </CopasiMT:is>
    <CopasiMT:is>
      <rdf:Bag>
...
To cite BioModels Database, please use: <a href="http://www.ncbi.nlm.nih.gov/pubmed/20587024" target="_blank">Li C, Donizelli M, Rodriguez N, Dharuri H, Endler L, Chelliah V, Li L, He E, Henry A, Stefan MI, Snoep JL, Hucka M, Le Novère N, Laibe C (2010) BioModels Database: An enhanced, curated and annotated resource for published quantitative kinetic models. BMC Syst Biol., 4:92.</a>
    ...
    <ListOfMetabolites>
      <Metabolite key="Metabolite_1" name="Vm" simulationType="ode" compartment="Compartment_1">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:CopasiMT="http://www.copasi.org/RDF/MiriamTerms#"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
...
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Metabolite_5">
    <CopasiMT:isVersionOf>
      ...
      <Metabolite key="Metabolite_7" name="FBP" simulationType="ode" compartment="Compartment_1">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:CopasiMT="http://www.copasi.org/RDF/MiriamTerms#"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_7">
    <CopasiMT:isVersionOf>
      ...
      <Metabolite key="Metabolite_9" name="NADHm" simulationType="ode" compartment="Compartment_1">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:CopasiMT="http://www.copasi.org/RDF/MiriamTerms#"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_9">
    <CopasiMT:isVersionOf>
      ...
      <Metabolite key="Metabolite_11" name="delta_psi" simulationType="ode" compartment="Compartment_1">
        <Expression>
...
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Metabolite_13">
    <CopasiMT:isVersionOf>
      ...
      <Metabolite key="Metabolite_15" name="ADPm" simulationType="ode" compartment="Compartment_1">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:CopasiMT="http://www.copasi.org/RDF/MiriamTerms#"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_15">
    <CopasiMT:isVersionOf>
      ...
      <Metabolite key="Metabolite_17" name="adp" simulationType="ode" compartment="Compartment_1">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:CopasiMT="http://www.copasi.org/RDF/MiriamTerms#"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_17">
    <CopasiMT:isVersionOf>
      ...
      <Metabolite key="Metabolite_19" name="c" simulationType="ode" compartment="Compartment_1">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:CopasiMT="http://www.copasi.org/RDF/MiriamTerms#"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_19">
    <CopasiMT:isVersionOf>
      ...
      <Metabolite key="Metabolite_21" name="Caer" simulationType="ode" compartment="Compartment_1">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:CopasiMT="http://www.copasi.org/RDF/MiriamTerms#"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_21">
    ...
    <ListOfModelParameterSets activeSet="ModelParameterSet_1">
      <ModelParameterSet key="ModelParameterSet_1" name="Initial State">
        <ModelParameterGroup cn="String=Initial Time" type="Group">
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations" value="0" type="Model" simulationType="time"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Initial Compartment Sizes" type="Group">
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Compartments[Compartment]" value="1" type="Compartment" simulationType="fixed"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Initial Species Values" type="Group">
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Compartments[Compartment],Vector=Metabolites[Vm]" value="-3.613285074e+25" type="Species" simulationType="ode"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Compartments[Compartment],Vector=Metabolites[n]" value="0" type="Species" simulationType="ode"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Compartments[Compartment],Vector=Metabolites[G6P]" value="1.81266467879e+26" type="Species" simulationType="ode"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Compartments[Compartment],Vector=Metabolites[FBP]" value="1.30078262664e+24" type="Species" simulationType="ode"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Compartments[Compartment],Vector=Metabolites[NADHm]" value="2.408856716e+23" type="Species" simulationType="ode"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Compartments[Compartment],Vector=Metabolites[delta_psi]" value="9.8763125356e+25" type="Species" simulationType="ode"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Compartments[Compartment],Vector=Metabolites[Cam]" value="1.204428358e+23" type="Species" simulationType="ode"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Compartments[Compartment],Vector=Metabolites[ADPm]" value="6.684577386899999e+24" type="Species" simulationType="ode"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Compartments[Compartment],Vector=Metabolites[adp]" value="6.84717521523e+26" type="Species" simulationType="ode"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Compartments[Compartment],Vector=Metabolites[c]" value="1.0237641043e+23" type="Species" simulationType="ode"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Compartments[Compartment],Vector=Metabolites[Caer]" value="2.07763891755e+26" type="Species" simulationType="ode"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[cm]" value="5300" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[Ik]" value="0" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[gK]" value="2700" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[n_infinity]" value="0.0001507103580597574" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[tau_n]" value="20" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[Ica]" value="-2927.841631627949" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[gCa]" value="1000" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[m_infinity]" value="0.03444519566621117" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[Ikca]" value="466.2961634994622" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[gkCa]" value="300" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[kd]" value="0.5" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[Ikatp]" value="2433.430257937914" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[gkATP_]" value="16000" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[katpo]" value="0.01013929274140798" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[topo]" value="110.2336389697232" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[bottomo]" value="10871.92586121306" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[mgadp]" value="187.605" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[adp3m]" value="153.495" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[atp4m]" value="68.15000000000001" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[JGPDH]" value="0.0007348469228349535" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[kGPDH]" value="0.0005" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[F6P]" value="90.3" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[JPFK]" value="0.3743640852798465" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[JPFK_ms]" value="0.0003743640852798465" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[bottom1]" value="1" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[weight1]" value="1" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[topa1]" value="0" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[k1]" value="30" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[k2]" value="1" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[k3]" value="50000" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[k4]" value="220" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[VmaxPFK]" value="5" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[weight2]" value="8444.404545454545" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[topa2]" value="0" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[bottom2]" value="8445.404545454545" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[topa3]" value="0.1630818" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[weight3]" value="0.1630818" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[bottom3]" value="8445.567627254544" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[f13]" value="0.02" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[f43]" value="20" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[f23]" value="0.2" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[f42]" value="20" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[f41]" value="20" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[weight4]" value="68.85643466004545" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[topa4]" value="69.01951646004545" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[bottom4]" value="8514.424061914589" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[weight5]" value="2.16" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[topa5]" value="69.01951646004545" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[bottom5]" value="8516.584061914589" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[weight6]" value="911.995690909091" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[topa6]" value="69.01951646004545" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[bottom6]" value="9428.57975282368" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[weight7]" value="1.76128344" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[topa7]" value="70.78079990004545" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[bottom7]" value="9430.341036263681" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[weight8]" value="37.18247471642454" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[topa8]" value="107.96327461647" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[bottom8]" value="9467.523510980105" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[weight9]" value="16.66666666666667" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[topa9]" value="107.96327461647" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[bottom9]" value="9484.190177646771" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[weight10]" value="7037.003787878788" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[topa10]" value="107.96327461647" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[bottom10]" value="16521.19396552556" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[weight11]" value="135.9015" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[topa11]" value="243.86477461647" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[bottom11]" value="16657.09546552556" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[weight12]" value="2869.018110835227" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[topa12]" value="3112.882885451697" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[bottom12]" value="19526.11357636079" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[weight13]" value="36" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[topa13]" value="3112.882885451697" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[bottom13]" value="19562.11357636079" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[weight14]" value="759.9964090909091" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[topa14]" value="3112.882885451697" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[bottom14]" value="20322.10998545169" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[weight15]" value="1467.7362" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[topa15]" value="3112.882885451697" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[bottom15]" value="21789.84618545169" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[weight16]" value="1549.269779851023" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[topa16]" value="4662.152665302719" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[bottom16]" value="23339.11596530272" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[topb]" value="1467.7362" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[lambda]" value="0.06" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[JPDH]" value="0.4516011603510686" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[p1]" value="400" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[p2]" value="1" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[p3]" value="0.01" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[JGPDHbas]" value="0.0005" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[JO]" value="0.4468135582351935" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[p4]" value="0.6" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[p5]" value="0.1" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[p6]" value="177" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[p7]" value="5" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[NADm]" value="9.6" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[NADmtot]" value="10" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[Cmito]" value="1.8" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[JHres]" value="5.212824846077259" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[p8]" value="7" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[p9]" value="0.1" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[p10]" value="177" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[p11]" value="5" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[JF1F0]" value="1.129015937076227" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[p13]" value="10" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[p14]" value="190" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[p15]" value="8.5" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[p16]" value="35" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[JHatp]" value="3.387047811228681" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[JGK_ms]" value="0.0004" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[JGK]" value="0.4" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[JHleak]" value="0.298" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[p17]" value="0.002" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[p18]" value="-0.03" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[JANT]" value="1.123950847247297" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[p19]" value="0.35" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[p20]" value="2" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[FRT]" value="0.037410133" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[RATm]" value="0.3513513513513514" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[Juni]" value="0.157794" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[p21]" value="0.04" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[p22]" value="1.1" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[JNaCa]" value="0.1622444295513875" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[p23]" value="0.01" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[p24]" value="0.016" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[fmito]" value="0.01" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[Jmito]" value="0.004450429551387441" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[ATPm]" value="3.9" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[Amtot]" value="15" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[Jhyd]" value="0.07973550000000001" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[khyd]" value="5e-05" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[khydbas]" value="5e-05" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[atp]" value="1363" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[atot]" value="2500" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[fcyt]" value="0.01" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[Jmem]" value="0.001175287342325771" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[kPMCA]" value="0.1" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[alpha]" value="4.5e-06" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[Cbas]" value="0.05" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[Jleak]" value="0.068966" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[pleak]" value="0.0002" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[JSERCA]" value="0.068" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[kSERCA]" value="0.4" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[Jer]" value="0.0009659999999999946" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[fer]" value="0.01" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[Vc_Ver]" value="31" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[gamma]" value="0.001" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[kappa]" value="0.001" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[delta]" value="0.07330827067669173" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[VK]" value="-75" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[VCa]" value="25" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Values[AMP]" value="500" type="ModelValue" simulationType="fixed"/>
        </ModelParameterGroup>
    ...
    <InitialState type="initialState">
      0 -3.613285074e+25 0 1.81266467879e+26 1.30078262664e+24 2.408856716e+23 9.8763125356e+25 1.204428358e+23 6.684577386899999e+24 6.84717521523e+26 1.0237641043e+23 2.07763891755e+26 0 0.0001507103580597574 -2927.841631627949 0.03444519566621117 466.2961634994622 2433.430257937914 0.01013929274140798 110.2336389697232 10871.92586121306 187.605 153.495 68.15000000000001 0.0007348469228349535 90.3 0.3743640852798465 0.0003743640852798465 8444.404545454545 0 8445.404545454545 0.1630818 0.1630818 8445.567627254544 68.85643466004545 69.01951646004545 8514.424061914589 2.16 69.01951646004545 8516.584061914589 911.995690909091 69.01951646004545 9428.57975282368 1.76128344 70.78079990004545 9430.341036263681 37.18247471642454 107.96327461647 9467.523510980105 16.66666666666667 107.96327461647 9484.190177646771 7037.003787878788 107.96327461647 16521.19396552556 135.9015 243.86477461647 16657.09546552556 2869.018110835227 3112.882885451697 19526.11357636079 36 3112.882885451697 19562.11357636079 759.9964090909091 3112.882885451697 20322.10998545169 1467.7362 3112.882885451697 21789.84618545169 1549.269779851023 4662.152665302719 23339.11596530272 1467.7362 0.4516011603510686 0.4468135582351935 9.6 5.212824846077259 1.129015937076227 3.387047811228681 0.0004 0.298 1.123950847247297 0.3513513513513514 0.157794 0.1622444295513875 0.004450429551387441 3.9 0.07973550000000001 1363 0.001175287342325771 0.068966 0.068 0.0009659999999999946 0.07330827067669173 1 5300 2700 20 1000 300 0.5 16000 0.0005 1 1 0 30 1 50000 220 5 0.02 20 0.2 20 20 0.06 400 1 0.01 0.0005 0.6 0.1 177 5 10 1.8 7 0.1 177 5 10 190 8.5 35 0.4 0.002 -0.03 0.35 2 0.037410133 0.04 1.1 0.01 0.016 0.01 15 5e-05 5e-05 2500 0.01 0.1 4.5e-06 0.05 0.0002 0.4 0.01 31 0.001 0.001 -75 25 500 
    </InitialState>
  </Model>
  <ListOfTasks>
...
<Report reference="Report_90" target="output_376.txt" append="0"/>
      <Problem>
...
<Report key="Report_90" name="Time, Concentrations, Volumes, and Global Quantity Values" taskType="timeCourse" separator="&#x09;" precision="6"> 
          <Table printTitle="1"> 
            <Object cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Reference=Time"/> 
	<Object cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Compartments[Compartment],Vector=Metabolites[Vm],Reference=Concentration"/> 
	<Object cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Compartments[Compartment],Vector=Metabolites[n],Reference=Concentration"/> 
	<Object cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Compartments[Compartment],Vector=Metabolites[G6P],Reference=Concentration"/> 
	<Object cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Compartments[Compartment],Vector=Metabolites[FBP],Reference=Concentration"/> 
	<Object cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Compartments[Compartment],Vector=Metabolites[NADHm],Reference=Concentration"/> 
	<Object cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Compartments[Compartment],Vector=Metabolites[delta_psi],Reference=Concentration"/> 
	<Object cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Compartments[Compartment],Vector=Metabolites[Cam],Reference=Concentration"/> 
	<Object cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Compartments[Compartment],Vector=Metabolites[ADPm],Reference=Concentration"/> 
	<Object cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Compartments[Compartment],Vector=Metabolites[adp],Reference=Concentration"/> 
	<Object cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Compartments[Compartment],Vector=Metabolites[c],Reference=Concentration"/> 
	<Object cn="CN=Root,Model=Bertram2007_IsletCell_Oscillations,Vector=Compartments[Compartment],Vector=Metabolites[Caer],Reference=Concentration"/> 
</Table> 
</Report>
  ...
  <SBMLReference file="BIOMD0000000376.xml">
    <SBMLMap SBMLid="ADPm" COPASIkey="Metabolite_15"/>
    ...
    <SBMLMap SBMLid="Caer" COPASIkey="Metabolite_21"/>
    ...
    <SBMLMap SBMLid="NADHm" COPASIkey="Metabolite_9"/>
    ...
    <SBMLMap SBMLid="Vm" COPASIkey="Metabolite_1"/>
    <SBMLMap SBMLid="VmaxPFK" COPASIkey="ModelValue_31"/>
    <SBMLMap SBMLid="adp" COPASIkey="Metabolite_17"/>
    ...
    <SBMLMap SBMLid="c" COPASIkey="Metabolite_19"/>
    <SBMLMap SBMLid="cm" COPASIkey="ModelValue_0"/>
    <SBMLMap SBMLid="delta" COPASIkey="ModelValue_147"/>
    <SBMLMap SBMLid="delta_psi" COPASIkey="Metabolite_11"/>
