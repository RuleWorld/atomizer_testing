...
Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products. The change of a product quantity is proportional to the quantity of one reactant.
  ...
  <Model key="Model_3" name="Morris2008 - Fitting protein aggregation data via F-W 2-step mechanism" simulationType="time" timeUnit="h" volumeUnit="ml" areaUnit="m²" lengthUnit="m" quantityUnit="mmol" type="deterministic" avogadroConstant="6.02214179e+23">
    <MiriamAnnotation>
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Model_3">
    ...
    <bqmodel:isDerivedFrom>
      <rdf:Bag>
        ...
        <rdf:li rdf:resource="http://identifiers.org/pubmed/11152691"/>
      </rdf:Bag>
    </bqmodel:isDerivedFrom>
    <dcterms:bibliographicCitation>
      <rdf:Bag>
        <rdf:li>
          <rdf:Description>
            <CopasiMT:isDescribedBy rdf:resource="http://identifiers.org/pubmed/19101068"/>
          </rdf:Description>
        </rdf:li>
      </rdf:Bag>
    </dcterms:bibliographicCitation>
    ...
    <dcterms:modified>
      <rdf:Description>
        <dcterms:W3CDTF>2015-01-23T16:47:22Z</dcterms:W3CDTF>
      </rdf:Description>
    </dcterms:modified>
    <CopasiMT:is>
      <rdf:Bag>
        <rdf:li rdf:resource="http://identifiers.org/biomodels.db/MODEL1501160001"/>
      </rdf:Bag>
    </CopasiMT:is>
    <CopasiMT:is>
      <rdf:Bag>
        <rdf:li rdf:resource="http://identifiers.org/biomodels.db/BIOMD0000000566"/>
      </rdf:Bag>
    </CopasiMT:is>
...
variable temperature and pH</div>
  ...
  and identified by: 
  <a href="http://identifiers.org/biomodels.db/BIOMD0000000566">BIOMD0000000566</a>.</p>
...
<rdf:RDF
  ...
  <body xmlns="http://www.w3.org/1999/xhtml">
    <pre>Polymeric form of the protein</pre>
        ...
        <Expression>
          &lt;CN=Root,Model=Morris2008 - Fitting protein aggregation data via F-W 2-step mechanism,Vector=Values[A0],Reference=Value&gt;-(&lt;CN=Root,Model=Morris2008 - Fitting protein aggregation data via F-W 2-step mechanism,Vector=Values[k1],Reference=Value&gt;/&lt;CN=Root,Model=Morris2008 - Fitting protein aggregation data via F-W 2-step mechanism,Vector=Values[k2],Reference=Value&gt;+&lt;CN=Root,Model=Morris2008 - Fitting protein aggregation data via F-W 2-step mechanism,Vector=Values[A0],Reference=Value&gt;)/(1+&lt;CN=Root,Model=Morris2008 - Fitting protein aggregation data via F-W 2-step mechanism,Vector=Values[k1],Reference=Value&gt;/(&lt;CN=Root,Model=Morris2008 - Fitting protein aggregation data via F-W 2-step mechanism,Vector=Values[k2],Reference=Value&gt;*&lt;CN=Root,Model=Morris2008 - Fitting protein aggregation data via F-W 2-step mechanism,Vector=Values[A0],Reference=Value&gt;)*exp((&lt;CN=Root,Model=Morris2008 - Fitting protein aggregation data via F-W 2-step mechanism,Vector=Values[k1],Reference=Value&gt;+&lt;CN=Root,Model=Morris2008 - Fitting protein aggregation data via F-W 2-step mechanism,Vector=Values[k2],Reference=Value&gt;*&lt;CN=Root,Model=Morris2008 - Fitting protein aggregation data via F-W 2-step mechanism,Vector=Values[A0],Reference=Value&gt;)*&lt;CN=Root,Model=Morris2008 - Fitting protein aggregation data via F-W 2-step mechanism,Reference=Time&gt;))
        </Expression>
      </Metabolite>
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  ...
  <body xmlns="http://www.w3.org/1999/xhtml">
    <pre>Average rate constant for aggregation</pre>
  </body>
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  ...
  <body xmlns="http://www.w3.org/1999/xhtml">
    <pre>Average rate constant for growth</pre>
  </body>

        </Comment>
      </ModelValue>
      <ModelValue key="ModelValue_2" name="A0" simulationType="fixed">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  ...
  <body xmlns="http://www.w3.org/1999/xhtml">
    <pre>Initial monomeric concentration of protein</pre>
  </body>
  ...
  <rdf:Description rdf:about="#Reaction_0">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4342" name="k1" value="8e-06"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_1">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4341" name="k1" value="0.034"/>
        </ListOfConstants>
        <KineticLaw function="Function_13">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_81">
    ...
    <ListOfModelParameterSets activeSet="ModelParameterSet_1">
      <ModelParameterSet key="ModelParameterSet_1" name="Initial State">
        <ModelParameterGroup cn="String=Initial Time" type="Group">
          <ModelParameter cn="CN=Root,Model=Morris2008 - Fitting protein aggregation data via F-W 2-step mechanism" value="0" type="Model" simulationType="time"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Initial Compartment Sizes" type="Group">
          <ModelParameter cn="CN=Root,Model=Morris2008 - Fitting protein aggregation data via F-W 2-step mechanism,Vector=Compartments[Brain]" value="1" type="Compartment" simulationType="fixed"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Initial Species Values" type="Group">
          <ModelParameter cn="CN=Root,Model=Morris2008 - Fitting protein aggregation data via F-W 2-step mechanism,Vector=Compartments[Brain],Vector=Metabolites[B]" value="-267436.8189126142" type="Species" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Morris2008 - Fitting protein aggregation data via F-W 2-step mechanism,Vector=Compartments[Brain],Vector=Metabolites[A]" value="6.022141790000001e+20" type="Species" simulationType="fixed"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          <ModelParameter cn="CN=Root,Model=Morris2008 - Fitting protein aggregation data via F-W 2-step mechanism,Vector=Values[k1]" value="8e-06" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Morris2008 - Fitting protein aggregation data via F-W 2-step mechanism,Vector=Values[k2]" value="0.034" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Morris2008 - Fitting protein aggregation data via F-W 2-step mechanism,Vector=Values[A0]" value="3.55" type="ModelValue" simulationType="fixed"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Kinetic Parameters" type="Group">
          <ModelParameterGroup cn="CN=Root,Model=Morris2008 - Fitting protein aggregation data via F-W 2-step mechanism,Vector=Reactions[Nucleation]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Morris2008 - Fitting protein aggregation data via F-W 2-step mechanism,Vector=Reactions[Nucleation],ParameterGroup=Parameters,Parameter=k1" value="8e-06" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Morris2008 - Fitting protein aggregation data via F-W 2-step mechanism,Vector=Values[k1],Reference=InitialValue&gt;
              </InitialExpression>
            </ModelParameter>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=Morris2008 - Fitting protein aggregation data via F-W 2-step mechanism,Vector=Reactions[Growth]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Morris2008 - Fitting protein aggregation data via F-W 2-step mechanism,Vector=Reactions[Growth],ParameterGroup=Parameters,Parameter=k1" value="0.034" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Morris2008 - Fitting protein aggregation data via F-W 2-step mechanism,Vector=Values[k2],Reference=InitialValue&gt;
              </InitialExpression>
            </ModelParameter>
          </ModelParameterGroup>
        </ModelParameterGroup>
    ...
    <InitialState type="initialState">
      0 -267436.8189126142 6.022141790000001e+20 1 8e-06 0.034 3.55 
    </InitialState>
  </Model>
  <ListOfTasks>
...
<Report reference="Report_90" target="output_566.txt" append="0"/>
      <Problem>
...
<Report key="Report_90" name="Time, Concentrations, Volumes, and Global Quantity Values" taskType="timeCourse" separator="&#x09;" precision="6"> 
          <Table printTitle="1"> 
            <Object cn="CN=Root,Model=Morris2008 - Fitting protein aggregation data via F-W 2-step mechanism,Reference=Time"/> 
	<Object cn="CN=Root,Model=Morris2008 - Fitting protein aggregation data via F-W 2-step mechanism,Vector=Compartments[Brain],Vector=Metabolites[B],Reference=Concentration"/> 
	<Object cn="CN=Root,Model=Morris2008 - Fitting protein aggregation data via F-W 2-step mechanism,Vector=Compartments[Brain],Vector=Metabolites[A],Reference=Concentration"/> 
</Table> 
</Report>
  ...
  <SBMLReference file="BIOMD0000000566.xml">
